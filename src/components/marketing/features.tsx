...
<p className="text-base md:text-lg text-center text-accent-foreground/80 mt-6">
  From product listings to payments, Shopigo gives you all the tools to run your store effortlessly — no coding or technical setup needed.
</p>
                ...
                <div className="flex flex-col items-center gap-5 lg:gap-5 w-full">
                    <Container>
                        <div className="grid grid-cols-1 lg:grid-cols-[1fr_.65fr] w-full gap-5 lg:gap-5">
                            <MagicCard particles={true} className="flex flex-col items-start size-full bg-secondary">
                            ...
                            <MagicCard particles={true} className="flex flex-col items-start w-full bg-secondary">
                                <div className="bento-card w-full flex-row gap-6">
                                    ...
                                    <div className="flex flex-col">
                                        ...
                                        Launch your online store in minutes. No coding. No stress. Just fill your details and go live.
                                        </p>
                                    </div>
                                </div>
                            </MagicCard>
                    ...
                    <Container>
                        <div className="grid grid-cols-1 lg:grid-cols-3 w-full gap-5 lg:gap-5">
                            <MagicCard particles={true} className="flex flex-col items-start w-full row-span-1 bg-secondary">
                                <div className="bento-card w-full flex-row gap-6">
                                    ...
                                    <div className="flex flex-col mt-auto">
                                        ...
                                        <p className="text-sm md:text-base mt-2 text-muted-foreground">
                                        Add, update, or remove products anytime — with clean layouts and organized categories.
                                        </p>
                                    </div>
                                </div>
                            </MagicCard>
                            <div className="grid grid-rows gap-5 lg:gap-5">
                                <MagicCard particles={true} className="flex flex-col items-start w-full row-span- row-start-[0.5] h-32 bg-secondary">
                                    <div className="bento-card w-full relative items-center justify-center">
                                        <div className="w-full absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
                                            ...
                                            Your store loads blazing fast and works perfectly on any device — phones, tablets, desktops.
                                            </p>
                                        </div>
                                ...
                                <MagicCard particles={true} className="flex flex-col items-start w-full row-start-2 !h-max bg-secondary">
                            ...
                            <MagicCard particles={true} className="flex flex-col items-start w-full row-span-1 bg-secondary">
                                <div className="bento-card w-full flex-row gap-6">
                                    <div className="flex flex-col mb-auto">
                                        ...
                                        <p className="text-sm md:text-base mt-2 text-muted-foreground">
                                        Accept payments easily through UPI — more options coming soon.
                                        </p>
                                    </div>
                            ...
                            <MagicCard particles={true} className="flex flex-col items-start w-full bg-secondary">
                                <div className="bento-card w-full flex-row gap-6">
                                    ...
                                    <div className="flex flex-col mt-auto">
                                        ...
                                        <p className="text-sm md:text-base mt-2 text-muted-foreground">
                                        Manage all your orders in one place — track, update, and handle customer queries smoothly.
                                        </p>
                                    </div>
                                </div>
                            </MagicCard>
                            <MagicCard particles={true} className="flex flex-col items-start w-full bg-secondary">
                                <div className="bento-card w-full flex-row gap-6">
                                    ...
                                    <div className="flex flex-col mt-auto">
                                        ...
                                        WhatsApp Support                                        </h4>
                                        <p className="text-sm md:text-base mt-2 text-muted-foreground">
                                        Let customers reach out directly via WhatsApp, and you handle support like a pro.
                                        </p>
                                    </div>
                                </div>
                            </MagicCard>
